...
**Required OAuth Scope:** `SDPOnDemand.changes.ALL`

To add this scope, re-authorize at:
`https://accounts.zoho.com/oauth/v2/auth?scope=SDPOnDemand.changes.ALL&client_id=CLIENT_ID&response_type=code&redirect_uri=REDIRECT_URI&access_type=offline`
